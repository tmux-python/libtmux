import { z } from 'zod'
import { ProtocolVersionSchema, PyLocationSchema } from './common.ts'
...
export const PyParsePayloadSchema = z.object({
  protocolVersion: ProtocolVersionSchema,
  modules: z.array(PyModuleSchema),
})

export type PyParameterKind = z.infer<typeof PyParameterKindSchema>
...
export type PyParsePayload = z.infer<typeof PyParsePayloadSchema>
