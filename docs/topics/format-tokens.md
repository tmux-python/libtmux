...
| 3.4 | `pane_unseen_changes` |
| 3.5 | `pane_key_mode` |
| 3.6 | `session_active`, `session_activity_flag`, `session_alert`, `session_bell_flag`, `session_silence_flag`, `client_theme` |
| 3.7 (forward) | `bracket_paste_flag`, `pane_flags`, `pane_floating_flag`, `pane_pb_progress`, `pane_pb_state`, `pane_pipe_pid`, `pane_zoomed_flag`, `synchronized_output_flag` |
