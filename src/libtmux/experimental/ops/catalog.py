...
def catalog(registry: OperationRegistry | None = None) -> list[CatalogEntry]:
    ...
    ['break_pane', 'capture_pane', 'clear_history', 'delete_buffer', 'detach_client',
    ...
    'select_window', 'send_keys', 'set_buffer', 'set_environment', 'set_hook',
    'set_option', 'set_window_option', 'show_buffer', 'show_options', 'source_file',
    'split_window', 'start_server', 'suspend_client', 'swap_pane', 'swap_window',
    'switch_client', 'unlink_window']
